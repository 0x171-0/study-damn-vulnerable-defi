...
這題我們運用了 [外部合約呼叫攻擊 Contracts interraction](https://www.so/Contracts-interraction-5ef422648fa34f9d9015bfc5227ef987) ，來讓 pool 把 token 所有權轉讓給我們。所以看到外部呼叫一定要特別小心，因為 call 裡面真的什麼都有可能發生。如果這題要修改的話應該要限制 `target.functionCall(data)` 呼叫的合約不能是 token。
